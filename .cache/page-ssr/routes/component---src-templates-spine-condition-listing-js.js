exports.id = "component---src-templates-spine-condition-listing-js";
exports.ids = ["component---src-templates-spine-condition-listing-js"];
exports.modules = {
...
const Breadcrumb = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("nav", {
    ...
    }, "\u203A"), isLast || !item.link ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
      className: "breadcrumb-current"
    }, item.label) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
      to: item.link
    }, item.label));
  })));
};
...
/***/ "./src/templates/spine-condition-listing.js?export=default":
/*!*****************************************************************!*\
  !*** ./src/templates/spine-condition-listing.js?export=default ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const SpineConditionListingTemplate = ({
  data
}) => {
  var _data$primaryChildren, _data$extraChildren, _data$allChildren, _condition$featuredIm, _condition$featuredIm2, _condition$spineCondi;
  ...
  const conditionTreatments = [...(((_data$primaryChildren = data.primaryChildren) === null || _data$primaryChildren === void 0 ? void 0 : _data$primaryChildren.nodes) || []), ...(((_data$extraChildren = data.extraChildren) === null || _data$extraChildren === void 0 ? void 0 : _data$extraChildren.nodes) || [])].filter((t, index, self) => index === self.findIndex(x => x.slug === t.slug));

  // All treatments from every condition (children only = have parentDatabaseId)
  const allTreatments = ((_data$allChildren = data.allChildren) === null || _data$allChildren === void 0 ? void 0 : _data$allChildren.nodes) || [];

  // Which treatments to show
  const treatmentsToShow = showAll ? allTreatments : conditionTreatments;
  const heroImage = ((_condition$featuredIm = condition.featuredImage) === null || _condition$featuredIm === void 0 ? void 0 : (_condition$featuredIm2 = _condition$featuredIm.node) === null || _condition$featuredIm2 === void 0 ? void 0 : _condition$featuredIm2.sourceUrl) || placeholderImage;
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_layout__WEBPACK_IMPORTED_MODULE_2__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main", {
    className: "spine-condition-listing-page"
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, showAll ? "All Treatments" : condition.title), !showAll && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    dangerouslySetInnerHTML: {
      __html: condition.content
    }
  }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", {
    className: "condition-switcher-section"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "container"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
  ...
  }, "All Conditions"), allConditions.map(cond => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
    key: cond.slug,
    to: `/spine-condition/${cond.slug}/`,
    className: `condition-tab ${!showAll && cond.slug === condition.slug ? "active" : ""}`,
    onClick: () => setShowAll(false)
  }, cond.title))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "condition-dropdown"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
    className: "condition-dropdown-btn",
    onClick: () => setDropdownOpen(!dropdownOpen)
  }, showAll ? "All Conditions" : condition.title, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
  ...
  }, cond.title)))))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", {
    className: "treatments-section"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "container"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "section-title-wrp"
  }, ((_condition$spineCondi = condition.spineConditionsPost) === null || _condition$spineCondi === void 0 ? void 0 : _condition$spineCondi.desciption) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "treatments-intro",
    dangerouslySetInnerHTML: {
      __html: condition.spineConditionsPost.desciption
    }
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "treatments-grid"
  }, treatmentsToShow.map((treatment, index) => {
    var _treatment$featuredIm, _treatment$featuredIm2;
    // For "all" view, find the parent condition to build correct URL
    const parentCondition = showAll ? allConditions.find(c => data.allWpSpineCondition.nodes.find(n => n.slug === c.slug)) : null;
    const linkTo = showAll ? `/spine-condition/${treatment.parentSlug || condition.slug}/${treatment.slug}/` : `/spine-condition/${condition.slug}/${treatment.slug}/`;
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      src: ((_treatment$featuredIm = treatment.featuredImage) === null || _treatment$featuredIm === void 0 ? void 0 : (_treatment$featuredIm2 = _treatment$featuredIm.node) === null || _treatment$featuredIm2 === void 0 ? void 0 : _treatment$featuredIm2.sourceUrl) || placeholderImage,
      alt: treatment.title
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SpineConditionListingTemplate);
const query = "1140672555";

/***/ })

};
;
//# sourceMappingURL=component---src-templates-spine-condition-listing-js.js.map