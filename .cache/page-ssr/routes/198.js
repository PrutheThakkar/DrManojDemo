...
_pointerDownHandler = function _pointerDownHandler() {
  ...
  return ScrollTrigger_win.getComputedStyle(element.nodeType === Node.DOCUMENT_NODE ? element.scrollingElement : element);
},
  ...
  var e = ScrollTrigger_doc.createElement("div"),
      ...
      parent = useFixedPosition ? ScrollTrigger_body : container.tagName === "IFRAME" ? container.contentDocument.body : container,
...
var ScrollTrigger_ScrollTrigger = /*#__PURE__*/function () {
  ...
  ScrollTrigger.enable = function enable() {
    ...
    if (ScrollTrigger_gsap) {
      ...
      } else if (ScrollTrigger_doc) {
        var onLoad = function onLoad() {
          ScrollTrigger.enable();

          ScrollTrigger_doc.removeEventListener("DOMContentLoaded", onLoad);
        };

        ScrollTrigger_doc.addEventListener("DOMContentLoaded", onLoad);
      }
    }
  };
...
ScrollTrigger_ScrollTrigger.version = "3.15.0";
