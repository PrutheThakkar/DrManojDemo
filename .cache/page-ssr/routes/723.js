...
// UNUSED EXPORTS: Swiper, SwiperSlide, useSwiper, useSwiperSlide
...
function updateSlides() {
  ...
  if (params.centeredSlides && params.cssMode) {
    (0,utils.b)(wrapperEl, '--swiper-centered-offset-before', '');
    (0,utils.b)(wrapperEl, '--swiper-centered-offset-after', '');
  }

  // set cssMode offsets
  if (params.cssMode) {
    (0,utils.b)(wrapperEl, '--swiper-slides-offset-before', `${offsetBefore}px`);
    (0,utils.b)(wrapperEl, '--swiper-slides-offset-after', `${offsetAfter}px`);
  }
  ...
  for (let i = 0; i < slidesLength; i += 1) {
    ...
    if (isVirtual && params.slidesPerView === 'auto') {
      ...
      if (params.roundLengths) {
        slideSize = swiper.isHorizontal() ? (0,utils.i)(slide, 'width', true) : (0,utils.i)(slide, 'height', true);
      } else {
  ...
  if (params.centeredSlides && params.cssMode && !params.centeredSlidesBounds) {
    (0,utils.b)(wrapperEl, '--swiper-centered-offset-before', `${-snapGrid[0]}px`);
    (0,utils.b)(wrapperEl, '--swiper-centered-offset-after', `${swiper.size / 2 - slidesSizesGrid[slidesSizesGrid.length - 1] / 2}px`);
  ...
  if (needNavigationInit) {
    if (swiper.isElement) {
      if (!nextEl || typeof nextEl === 'string') {
        ...
        (0,utils.s)(nextEl, swiper.navigation.arrowSvg);
      ...
      if (!prevEl || typeof prevEl === 'string') {
        ...
        (0,utils.s)(prevEl, swiper.navigation.arrowSvg);
...
const swiper_react_Swiper = /*#__PURE__*/(0,index_js_.forwardRef)(({
  className,
  tag: Tag = 'div',
...
const SwiperSlide = /*#__PURE__*/(0,index_js_.forwardRef)(({
  tag: Tag = 'div',
  children,
  className = '',
  swiper,
...
/* harmony export */ });
/* unused harmony exports a, f, g, k, m, o, p */
...
// UNUSED EXPORTS: A11y, Autoplay, Controller, EffectCards, EffectCoverflow, EffectCreative, EffectCube, EffectFade, EffectFlip, FreeMode, Grid, HashNavigation, History, Keyboard, Manipulation, Mousewheel, Navigation, Pagination, Parallax, Scrollbar, Thumbs, Virtual, Zoom
