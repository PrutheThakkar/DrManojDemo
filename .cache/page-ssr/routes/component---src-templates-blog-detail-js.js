...
const placeholderImage="https://placehold.co/600x400?text=No+Image";const BlogDetailTemplate=({data})=>{var _post$featuredImage,_post$featuredImage$n;const post=data.wpPost;const heroImage=((_post$featuredImage=post.featuredImage)===null||_post$featuredImage===void 0?void 0:(_post$featuredImage$n=_post$featuredImage.node)===null||_post$featuredImage$n===void 0?void 0:_post$featuredImage$n.mediaItemUrl)||placeholderImage;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_layout__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main",{className:"blog-detail-page"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section",{className:"about-hero-section"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"about-hero-bg"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img",{src:heroImage,alt:post.title})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"about-hero-content"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",{dangerouslySetInnerHTML:{__html:post.title}}))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section",{className:"blog-detail-content"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"container"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"blog-content-body",dangerouslySetInnerHTML:{__html:post.content}})))));};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BlogDetailTemplate);const query="627190883";
